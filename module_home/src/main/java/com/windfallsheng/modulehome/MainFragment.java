package com.windfallsheng.modulehome;
...
import com.windfallsheng.libbase.route_service.ModuleRouteService;
...
public class MainFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_goto_login) {
            ...
            Uri testUriMix = Uri.parse("arouter://com.XXX.XXX/me/main/EventBus");
            ARouter.getInstance().build(testUriMix)
                    .withString("name", "windfallsheng_Uri跳转")
                    .withLong("age", 25)
                    .withParcelable("eventbus", eventBusBean)
                    .navigation();
            ...
            ARouter.getInstance()
                    ...
                    .navigation(getContext(), new NavCallback() {
                        ...
                        public void onLost(Postcard postcard) {
                            ...
                            //路由被丢失时调用
                            Log.e("windfallsheng", "丢失了");
                        }

                        @Override
                        public void onArrival(Postcard postcard) {
                            //路由到达之后调用
                            Log.e("windfallsheng", "到达了");
                        }
    ...
    public void onEvent(String s) {
        UIUtils.showToast("收到EventBus数据内容：" + s);
    }
