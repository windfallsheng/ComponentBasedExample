package com.windfallsheng.componentbasedexample;
...
import com.windfallsheng.componentbasedexample.utils.FragmentUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FragmentUtils.getHomeFragment() == null) {
            UIUtils.showToast("app 模块单独编译模式");
            return;
        }
        initData();
        initView();
